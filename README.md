...
<script>
  window.UNIVERSAL_DARK_MODE_OPTIONS = {
    ...
    position: 'top-right'   // default: 'bottom-right', supports top-left, top-center, top-right, middle-left, middle-center, middle-right, bottom-left, bottom-center, bottom-right
  };
</script>
